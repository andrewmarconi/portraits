...
try:
    from generate_headshot import generate_headshot
...
try:
    from create_mesh_morphing import create_mesh_morphing_video
...
def generate_image_ui(prompt, num_images, lora_path, lora_scale, clip_skip, width, height):
    ...
    try:
        result_paths = generate_headshot(
            prompt=prompt,
        ...
        return result_paths, f"✓ Generated {len(result_paths)} image(s) successfully!"
...
def create_image_tab():
    ...
    with gr.Tab("🖼️ Image Generation"):
        ...
        generate_btn.click(
            ...
            inputs=[prompt_input, num_images_input, lora_path_input, lora_scale_input, clip_skip_input, width_input, height_input],
    ...
    with gr.Tab("🎬 Text-to-Video"):
        ...
        **Note:** Model must be downloaded first:
        ...
        generate_video_btn.click(
            ...
            inputs=[video_prompt_input, num_frames_input, guidance_scale_input, num_inference_steps_input],
...
def create_morphing_tab():
    ...
    with gr.Tab("🎭 Video Morphing"):
        ...
        **Note:** This feature requires uploading multiple face images or using generated images from the output folder.
        ...
        2. Run the morphing script from command line:
        ```bash
        uv run python create_mesh_morphing.py
        ```

        **Coming soon:** Direct upload and morphing in this interface!
        """)
